...
class Fraction {
  ...
  public static void main(String[] argv) {
    ...
    Fraction sumOfTwo = new Fraction(
            (f1.numerator * f2.denominator + 
            f2.numerator * f1.denominator ), 
            f1.denominator * f2.denominator);              // Sum of f1 and f2.
    Fraction sumOfThree = new Fraction(             // Sum of f0, f1, and f2.
        (f0.numerator * f1.denominator * f2.denominator + 
         f0.denominator * f1.numerator * f2.denominator +
         f0.denominator * f1.denominator * f2.numerator),
