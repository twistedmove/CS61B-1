...
public class RunLengthEncoding implements Iterable {
  ...
  public RunLengthEncoding(int width, int height) {
    // Your solution here.
    this.color = new mylist();
    this.color.insertEnd(0, 0, 0, width*height);
    this.width = width;
    this.height = height;
    this.runs = 1;
  }
  ...
  public RunLengthEncoding(int width, int height, int[] red, int[] green,
    ...
    int len = red.length;
    this.color = new mylist();
    this.runs = runLengths.length;
    for(int i = 0; i < len; i++) {
        this.color.insertEnd(red[i], green[i], blue[i], runLengths[i]);
    }
  ...
  public RunIterator iterator() {
    // Replace the following line with your solution.
    return new RunIterator(this.color);
  ...
  public PixImage toPixImage() {
    ...
    for(int x = 0; x < width; x++) {
        for(int y = 0; y < height; y++) {
            System.out.println(this.runs + ">>>>>" + times.length);
            if(times[index] > 0) {
                pict.setPixel(x, y, (short) array[index][0], (short) array[index][1], (short) array[index][2]);
                times[index]--;
            } else {
                index++;
                continue;
  ...
  public static void main(String[] args) {
    ...
    System.out.println(rle1.getWidth() + rle1.getHeight() + "wwwww");
