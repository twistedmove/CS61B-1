...
public class RunIterator implements Iterator {
  ...
  public boolean hasNext() {
    ...
    return this.curr.next != this.runs.head;
  ...
  public int[] next() {
    ...
    int[] val = {this.curr.times, this.curr.red, this.curr.green, this.curr.blue};
    return val;
  }
